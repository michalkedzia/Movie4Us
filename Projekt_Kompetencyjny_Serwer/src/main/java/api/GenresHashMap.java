...
public class GenresHashMap {
    private static final String GENRES_URL = "https://api.themoviedb.org/3/genre/movie/list?api_key=f315a3238066ebb41551a49a0984e185&language=en-US";
    ...
    public HashMap<Integer, String> getGenresMap() throws IOException {
        ...
        for (int i = 0; i < array.size(); i++) {
            GENRES_MAP.put(array.get(i).getAsJsonObject().get("id").getAsInt(), array.get(i).getAsJsonObject().get("name").getAsString());
        }
