                        ...
                        new CardStackListener() {
                            ...
                            public void onCardSwiped(Direction direction) {
                                ...
                                if (direction == Direction.Right) {
                                    ...
                                    //************************************************************
                                    path[0] = adapter.returnPathToImage(manager.getTopPosition() - 1);
                                    title[0] = adapter.returnTitle(manager.getTopPosition() - 1);
                                    description[0] = adapter.returnDescription(manager.getTopPosition() - 1);
                                    rating[0] = adapter.returnFilmRating(manager.getTopPosition() - 1);
                                }
                    ...
                    while (litener) {
                        ...
                        switch (message.getAction()) {
                            ...
                            case "match": {
                                ...
                                // TODO opracowanie widoku pop-outu przy matchu filmów -> argumnenty przekazywane
                                // przez putExtra

                                Intent matach = new Intent(getApplicationContext(), Match.class);
                                matach.putExtra("value", path[0]);
                                matach.putExtra("value2", title[0]);
                                matach.putExtra("value3", description[0]);
                                matach.putExtra("value4", rating[0]);
